...
Question 1 (5 marks) — UK macroeconomic data 2021–2024
 ...
 1(b)    Context for markers: between 2022 and 2024 the Bank of England raised the                4
         ...
         Higher mortgage rates reduce housing affordability; fewer households can
         satisfy lender stress tests; demand for housing falls → nominal house price
         growth slows or prices fall; fewer transactions; falling housing market activity
         (2).
         Households on variable-rate mortgages, or rolling off fixed deals, face sharply
         higher monthly payments → reduced disposable income → reduced
         willingness to move or trade up → further reduction in demand (2).
         Accept alternatives: rental market effects (higher buy-to-let financing costs
         pushed up rents); impact on first-time buyers; impact on new-build
         construction; regional variation; modest rate cuts in 2024 provided limited relief
...
Question 3 (5 marks) — UK government net borrowing
 ...
 3(b)    Diagram (2): upward-sloping SRAS, downward-sloping AD; show AD shifting                4
         right from AD₁ to AD₂ following the rise in G; new equilibrium at higher price
         level P₂ and higher real output Y₂.
         Analysis (2): borrowing-funded spending is a direct injection into the circular
         flow. Via the multiplier (1/(1−MPC)), initial government spending generates
         subsequent rounds of induced consumption, raising real GDP in the short run.
         The magnitude depends on the size of the output gap, the multiplier, crowding-
...
Question 4 (5 marks) — UK current-account deficit
 ...
 4(a)    Accept ONE developed policy. Award 2 marks for policy identification and 2             4
         marks for mechanism/chain.
         Example 1: Contractionary fiscal policy. Raise taxes or cut spending →
         reduces disposable income and AD → reduces demand for imports (income-
         elastic) → improves trade balance (Marshall-Lerner condition).
         Example 2: Supply-side policy to improve competitiveness. Investment in
         skills / R&D / infrastructure → raises labour productivity → lowers unit labour
         costs → makes UK exports more price-competitive.
         Example 3: Engineered currency depreciation / relaxed monetary policy. Lower
         interest rates → weaker sterling → cheaper exports, dearer imports →
         improved trade balance (subject to Marshall-Lerner).
...
Question 5 (5 marks) — Raising UK long-run trend growth
 ...
 5(a)    Answer: C — Increased investment in education and research & development.             1
         ...
         creates a disincentive to work and may reduce labour supply; D reduces
         consumption and AD but does not raise productive capacity.

 5(b)    Accept ONE developed supply-side policy (definition + chain, 2 marks each for         4
         two linked points, up to 4):
         Infrastructure investment: public capital spending on transport, digital networks
         and energy reduces firms' costs and raises productivity. Chain: lower logistics
         costs → higher competitiveness → higher potential output → LRAS shifts right.
         Skills and training: raises human capital, reduces structural unemployment,
         raises labour productivity.
         Deregulation / planning reform: lowers barriers to entry, raises contestability in
         goods/labour markets, improves allocative efficiency.
         Tax reform: cutting corporation tax raises post-tax return on capital → higher
         investment → larger capital stock → higher productive capacity.
         Accept: R&D tax credits, apprenticeships policy, immigration reform, childcare
...
negative output gaps in the short run; it cannot raise trend growth sustainably (the neoclassical
long-run view).
Case for demand-side: persistent demand deficiency (hysteresis) can erode productive capacity;
Keynesian view holds that strong demand stimulates investment, which is the main driver of
capital-stock growth. Monetary-fiscal coordination matters in deep recessions.
Judgement: supply-side is necessary but not sufficient for trend growth; best delivered in
...
6(c) — Impact of long-term sickness on UK recovery (10 marks)
 ...
 • Wage pressure: tighter labour market              shock.
...
channels.
 ...
 • Transmission to market rates: mortgage          • Sacrifice ratio: growth held back; UK below
   rates rose from ~2% to >6% (Extract B).           pre-pandemic trend by 4.7% in 2024
 • Affordability shock for ~1.6m re-fixing           (Figure 1).
   households in 2024; monthly payments up         • Transmission lags mean the full output
   £240–£400.                                        effects appeared gradually.
 • AD effects: lower consumption via debt-         • Distributional impact: young mortgage-
 ...
 • Exchange-rate channel: supported sterling         response to a 9.1% inflation reading, but
   ...
   disinflation via import prices.                   probably too tight for the recovery. Cutting
 • Diagram: AD shifts left from AD₁ to AD₂;          earlier or more gradually could have
   new equilibrium at lower real output and          preserved more output. Net, effective on
   lower price level (or slower rise in price        inflation but costly for real activity.
   level).
...
6(e) — Public borrowing to fund a one-off rise in public investment (15 marks)
 ...
 • Diagram: AD shifts right short-run; LRAS        • Judgement: a well-designed, well-targeted
   shifts right long-run (the 'twin shift'           one-off investment package can generate
   analysis).                                        both short-run demand support and long-
                                                     run supply benefits, but the current
                                                     environment (elevated debt, high interest
                                                     rates, tight capacity in some sectors) raises
                                                     the cost and delivery risk. Justifiable only
...
marks)
 ...
 • Distributional: hits lower earners as a         reducing borrowing; macroeconomic effect
   proportion of income; affects more workers      modestly contractionary; distributional
   as nominal wages rise.                          impact regressive. Better targeted
 • Diagram: AD/AS with leftward AD shift; or       alternatives (property tax reform, wealth-
   labour-supply curve shifting left due to        tax variants, closing reliefs) may offer
   disincentive.                                   similar revenue with fewer work-incentive
                                                   effects.
...
(25 marks)
 ...
 • Current framework: BoE has operational        • Counter: narrow inflation mandate may
   independence with a 2% CPI target; MPC          neglect employment / financial-stability
   sets Bank Rate.                                 objectives.
 ...
 • International evidence: countries with        • Risk of 'monetary-policy dominance' and
    independent, inflation-targeting central       insufficient fiscal coordination in crises (the
    banks had lower average inflation through      zero-lower-bound problem).
    1990s–2010s.
                                                 • Judgement: stronger mandate unlikely to
 • Diagrams: Phillips curve (SRPC shift);          deliver large marginal gains over current
...
9EC0/02 — Moderate — Mark Scheme                                                        Page 9 of 10
            KAA (AO1 + AO2 + AO3)                           Evaluation (AO4)
                                                 ...
                                                 scrutiny of policy framework rather than
                                                 tightening the rule.
