...
Question 1 (5 marks) — Turkey's inflation and lira depreciation
 ...
 1(b)    Marker note: the paper does not provide a Turkey-specific data table;                  4
         ...
         context. Full credit is available whether or not specific lira exchange-rate values
         are recited.
         Accept up to TWO linked effects, each 2 marks (identification + chain):
         Imported inflation: the lira fell heavily against the US$ between 2021 and 2024
         (from roughly 7.4 to 35.4 per US$ by end-2024). Dollar-priced imports (energy,
         raw materials, intermediate inputs) become much more expensive in lira terms
         → imported-cost inflation feeds directly into CPI (2).
         Competitiveness and trade balance: a weaker lira makes Turkish exports
         ...
         household purchasing power as lira-denominated wages lose value against
...
Question 2 (5 marks) — Negative output gap and AD/AS
 ...
 2(a)    AD/AS: a negative output gap persists when sticky wages and prices prevent             2
         rapid downward adjustment (Keynesian SRAS is flat over the gap) (1). Without
...
9EC0/02 — Hard — Mark Scheme                                                             Page 3 of 10
   Q                                      Indicative content                                       Mark
         ...
         Accept: hysteresis (prolonged weakness damages potential); liquidity trap /
         ZLB prevents interest-rate adjustment; expectations of weak demand become
         self-fulfilling.
...
Question 3 (5 marks) — Keynesian fiscal multipliers by income group
 ...
 3(a)    Answer: B — the importance of marginal propensity to consume in determining                1
         ...
         coefficients; C crowding-out is about interest-rate and resource constraints; D
         Ricardian equivalence concerns forward-looking saving behaviour.

 3(b)    Simple closed-economy Keynesian multiplier with tax rate t: k = 1 / (1 − MPC ×             4
         (1 − t)).
         Package (i) low-income MPC = 0.65: k = 1 / (1 − 0.65 × 0.7) = 1 / (1 − 0.455) =
         1 / 0.545 ≈ 1.83 (2).
         Package (ii) high-income MPC = 0.20: k = 1 / (1 − 0.20 × 0.7) = 1 / (1 − 0.14) =
         1 / 0.86 ≈ 1.16 (2).
         Award 1 mark for correct formula; 1 mark for each numerical multiplier; accept
         answers 1.8 and 1.15 with working.
         Interpretation: the low-income programme generates roughly 58% more short-
...
Question 4 (5 marks) — Sterling depreciation and CPI pass-through
 ...
 4(a)    Method: first-year CPI impact = pass-through × import share × magnitude of                 4
         depreciation (2).
         Calculation: 0.55 × 0.28 × 8% = 0.154 × 8% = 1.23% (2).
         Accept answers in the range 1.2–1.25%. Award 1 mark for correctly multiplying
         pass-through × import share (0.154); 1 mark for applying to the 8%
         depreciation; 2 marks for correct numerical answer with unit.
         Accept alternative framings that reach 1.23% via decomposing first to 'import-
...
9EC0/02 — Hard — Mark Scheme                                                                 Page 4 of 10
 ...
 4(b)    Answer: D — a market with low substitutability between imported and                   1
         ...
         Distractors: A importers with pricing-to-market power absorb some of the shock
         (lower pass-through); B invoicing in the importer's currency reduces pass-
         through; C extensive import substitution raises competitive pressure on
...
Question 5 (5 marks) — Secular stagnation
 ...
 5(b)    Accept ONE fully developed chain, 4 marks (concept + mechanism):                      4
         Savings glut (Bernanke 2005): high desired saving in emerging economies
         (China, oil exporters) following Asian crisis financial caution and current-
         account surpluses → large inflows of capital into advanced-economy financial
         markets → push down 'equilibrium' real interest rates globally (2).
         At the zero lower bound (ZLB), monetary policy cannot push actual real rates
         below the required equilibrium rate → demand remains chronically deficient →
         secular stagnation characterised by low growth, low inflation, and negative real
         rates even at full employment (2).
         Accept: link to demographic factors in EM; link to reserve-accumulation
         motives post-1997; link to domestic saving gluts (e.g. German export-led
         growth).
...
6(c) — Demand-side vs supply-side factors in Japanese stagnation (10 marks)
 ...
 • Corporate governance: cross-                      factors (demographics, productivity)
   shareholdings, keiretsu structures, low           became more binding from 2010s
...
9EC0/02 — Hard — Mark Scheme                                                            Page 6 of 10
            KAA (AO1 + AO2 + AO3)                               Evaluation (AO4)
                                                   ...
                                                   support, which allowed demand weakness
...
induced expansion.
 ...
 • Transmission channels: portfolio-balance         created exit-strategy challenges.
   (compressing term premium), signalling         • Wealth channel benefits largely captured
   (anchoring expectations), exchange-rate          by asset holders (older, wealthier).
...
9EC0/02 — Hard — Mark Scheme                                                           Page 7 of 10
 ...
 • Diagrams: LRAS shift from structural              integration. However, applicability depends
   reform; AD support from arrows 1–2.               heavily on initial conditions: works best
                                                     where the binding constraint is institutional
                                                     rigidity (Japan, Italy, Germany), less
                                                     transformative in economies where
                                                     flexibility is already present (UK, US).
                                                     Structural reform complemented by
                                                     credible demand management offers the
...
Question 7 — Modern Monetary Theory and UK policy (25 marks)
 ...
 • Job guarantee a key policy proposal to              market channels faster than MMT
   stabilise both employment and inflation.            proponents allow.
 ...
 • Recent stress test: 2022 mini-budget                framework is a real asset MMT would
   ...
   sterling fall, forcing policy reversal.             nominal financing constraint) is correct but
                                                       ...
                                                       inflation is the only real constraint
                                                       understates the role of credibility, financial-
...
9EC0/02 — Hard — Mark Scheme                                                               Page 9 of 10
 ...
 • Case for coordination: at the ZLB,                rather than a formal coordination
   coordination is essential (as in 2008–2010        framework.
   and 2020); in normal times, coordination        • Judgement: disagree with the premise.
   may become collusion and compromise               Central-bank independence retains
   credibility.                                      substantial value even in the current
 • International practice: US Fed operationally      environment; the relevant reform is better
    independent; Japan BoJ closely                   communication and more systematic
    coordinated with MoF via government-led          accountability, not formal coordination.
    framework.                                       Informal coordination mechanisms (shared
                                                     forecast base, clear communication of
