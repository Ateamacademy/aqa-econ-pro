...
Question 1 (5 marks) — UK ETS carbon permits
 ...
 1(a)    Method: PES = %ΔQs ÷ %ΔP (1).                                                            4
         %ΔQs = −12% (cap reduced permits issued).
         %ΔP = (£72 − £45) ÷ £45 × 100 = +60% (1).
         PES = −12 ÷ 60 = −0.20 (accept 0.2 in absolute value; accept answers in the
         range −0.18 to −0.22 with valid working) (2).
         Accept alternative valid interpretation: because the quantity change was driven
         by a regulator-set cap rather than a movement along a supply curve,
         candidates may argue that supply is effectively price-inelastic or vertical over
...
Question 2 (5 marks) — Pension auto-enrolment and bounded rationality
 ...
 2(a)    Bounded rationality: workers have limited cognitive capacity, time and                   4
         information; decisions about long-term savings involve complex uncertainty (1).
         Choice architecture: default settings anchor behaviour; in the opt-in condition,
         inertia and status-quo bias keep participation low at 38%; in the opt-out
 ...
 2(b)    Answer: B — status-quo bias effect. The same set of workers reaches opposite             1
         ...
         Distractors: A positive externalities relate to third-party benefits in production or
         consumption, not to decision-framing; C moral hazard describes post-contract
         behavioural change when actions are unobservable, which is not what this
         experiment captures; D Giffen paradox concerns an upward-sloping demand
...
Question 3 (5 marks) — Supermarket petrol game theory
 ...
 3(a)    Nash equilibrium: (Cut, Cut) with payoffs (4, 4). At this strategy pair, neither         2
         ...
         correct NE identified with payoffs.
...
Question 4 (5 marks) — Monopsony and the minimum wage
 ...
 4(a)    Diagram: upward-sloping labour supply (S_L = ACL); MCL curve steeper                     4
         above ACL because monopsonist pays all workers the higher wage to hire one
         more. Labour demand D_L = MRPL (1).
         Monopsony equilibrium: firm hires where MCL = MRPL at Q_m; pays wage
         W_m read off the supply curve, below W_competitive (1).
...
Question 5 (5 marks) — NLW and grocery retail wage bill
 ...
 5(b)    Acceptable reasons (any ONE developed, 2 marks for definition + chain):                  2
...
9EC0/01 — Hard — Mark Scheme                                                               Page 4 of 10
   Q                                   Indicative content                                  Mark
         ...
         increases through to prices without major quantity effects (1+1).

 5(c)    Wage bill per worker per week old: £11.44 × 30 = £343.20. New: £12.21 × 30 =       2
         £366.30. Rise per worker: £366.30 − £343.20 = £23.10 per week.
         For 400 workers: 400 × £23.10 = £9,240 per week.
         Alternative method: rise in hourly rate = £0.77; × 30 hours × 400 workers =
         £9,240.
...
MC diagram is acceptable.
 ...
 • Diagram: new entrants shift industry supply      digital-native and fee-free segments. But
   ...
   price/commission.                                deposits, mortgages, and cross-selling
                                                    remains largely intact. Meaningful
                                                    competition requires additional structural
                                                    measures.
...
6(d) — Behavioural biases vs. structural market power (10 marks)
 ...
 • CASS (Current Account Switch Service)              • Judgement: behavioural biases amplify
   ...
   not shifted behaviour.                               obstacle is structural — without credible
                                                        ...
                                                        to create alternatives AND behavioural
                                                        reform to prompt engagement. Neither
                                                        alone is sufficient.
...
6(e) — Impact of Starling/Monzo merger on consumers (15 marks)
 ...
 • Possible reduction in choice among digital-          displacement of incumbents.
   native propositions (Extract C).                   • Judgement: merger creates short-run
                                                        reduction in choice among digital
...
9EC0/01 — Hard — Mark Scheme                                                               Page 7 of 10
            KAA (AO1 + AO2 + AO3)               Evaluation (AO4)
                                    ...
                                    remedies (e.g. keep separate brands for 3–
                                    5 years, portability commitments). On
                                    balance, likely net positive for consumers if
                                    regulated carefully.
...
marks)
 ...
 • Pigouvian framework: taxes internalise           • Nudges advantages: low cost, preserve
 ...
 • Nudges: choice architecture to harness           • Nudges disadvantages: modest effect
   ...
   exploits default bias; warning labels              behaviours (alcohol, tobacco).
   address information failures.                    • Pigouvian disadvantages: regressive (falls
 • Diagram: tax shifts S left and reduces Q to        on lower-income consumers); may cause
   Q_social (allocative efficiency restored).         cross-border substitution; risk of illicit
 • Evidence on SDIL: reformulation                    markets.
   successful; consumption of sugar from soft       • Asymmetry of the externality: health effects
   drinks fell ~30%.                                  individualised, whereas Pigouvian
 • Behavioural insights: traffic-light labelling,     framework assumes clear third-party harm.
   portion-size defaults, restaurant menu           • Judgement: nudges and taxation are
   calorie labelling.                                 complementary, not substitutes. Taxation
                                                      better where external costs are large and
...
Question 8 — Algorithmic pricing and tacit collusion (25 marks)
 ...
 • Theoretical basis: Q-learning and                  (2023) find algorithmic tacit collusion in
   reinforcement-learning algorithms                  German petrol forecourts; other studies
   converge on supra-competitive prices in            find purely competitive outcomes.
   repeated games without explicit                  • Prohibition may chill innovation and raise
   agreement.                                         compliance costs; risks extensive false
 • Example industries: online retail (Amazon          positives.
   marketplace), petrol forecourts, airline         • Alternative: outcome-focused enforcement
   tickets, dynamic-pricing ride-hailing.             (investigate markets where margins rise
 • Competition law implication: traditional           without explicit agreement).
   cartel law requires proof of agreement;          • Jurisdictional issue: algorithms run across
   algorithms make this difficult.                    borders; unilateral UK ban may be
...
9EC0/01 — Hard — Mark Scheme                                                             Page 9 of 10
   ...
   predictions).                                    concentrated markets where collusion is
                                                    theoretically most likely (≤4 competitors,
                                                    transparent pricing); sandbox testing of
                                                    algorithms before deployment; an
                                                    outcome-based market investigation tool.
                                                    The claim that algorithmic pricing
                                                    'inevitably' leads to collusion is an
                                                    overstatement.
