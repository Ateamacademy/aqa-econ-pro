...
Question 1 (5 marks) · Argentina's inflation and fiscal consolidation
 ...
 1(a)    Answer: A · Hyperinflation followed by disinflation. Argentina's annual CPI          1
         ...
         rule framework rather than an Argentina data table; Q1a asks about 'the data'
         which is not directly supplied. Award full credit for a correct answer consistent
         with widely-reported Argentine inflation trajectory. Candidates are not
         penalised for this extraction-level inconsistency.

 1(b)    Accept up to TWO linked effects, each 2 marks (identification + chain):              4
         Sharp cut in government spending (real 30% cut, removal of energy and
         transport subsidies) reduces AD → lower real GDP in the short run; rising
         unemployment; fall in real consumption (2).
         Subsidy removal raises the price level of previously subsidised goods (energy,
         transport). Produced an initial spike in headline inflation in early 2024, before
         disinflation set in as AD weakened and monetary-financing-driven inflation was
         brought under control (2).
         Accept alternatives: improvement in the fiscal deficit and reduction in debt-
         monetisation → lower inflation in the medium run; risk of recession and political
         instability; distributional effects on lower-income households; balance-of-
...
9EC0/02 · Advanced · Mark Scheme                                                        Page 3 of 9
   Q                                   Indicative content                                      Mark
         ...
         Distractors: A discretionary response to current data is precisely the approach
         that long lags make unreliable; C fixed exchange-rate regimes constrain
         monetary policy and are unrelated to the lag problem; D a higher inflation
...
Question 3 (5 marks) · Ricardian equivalence
 ...
 3(a)    Answer: B · Households are forward-looking with unlimited planning horizons.            1
         ...
         cannot smooth consumption); C misunderstands the hypothesis; D is
         unrelated.

 3(b)    Accept TWO reasons, 2 marks each (identification + chain):                              4
         1. Credit constraints: many households cannot borrow against future income,
         so a tax cut today raises current consumption directly, rather than being fully
         saved (2).
         2. Finite horizons and uncertainty: households do not plan over infinite
         horizons; Blanchard's 'perpetual-youth' model shows that debt-financed tax
         cuts raise consumption because the current generation may not fully internalise
         future tax liabilities (2).
         Accept: distortionary taxation (future taxes are not lump-sum); population
         growth (future taxes spread over more households); heterogeneity in MPC
         across the income distribution; imperfect knowledge of future fiscal policy;
...
Question 4 (5 marks) · Hysteresis
 ...
 4(a)    Accept ONE developed mechanism, 4 marks (identification + chain +                       4
         application):
         Skill atrophy: long-term unemployed workers lose job-specific skills (human
         capital depreciates) → become less productive relative to the employed →
         firms are reluctant to hire → they remain outside the labour force even when
         AD recovers (2+2).
         Accept: insider-outsider effects in wage bargaining; scarring effects on young
...
Question 5 (5 marks) · Optimum Currency Area
 ...
 5(a)    Answer: B · a large, asymmetric external supply shock. When a shock hits              1
         ...
         channels or risk-sharing in the face of shocks).

 5(b)    Accept ONE fully developed reason, 4 marks:                                           4
         Limited fiscal risk-sharing: euro area has a common monetary policy but no
...
to cut infrastructure spending, perpetuating investment-led model.
2. Political: CCP legitimacy partly rests on sustained high GDP growth (social-stability imperative);
consumption-led growth is lower-headline but harder to engineer through top-down planning.
3. Household savings behaviour: weak social safety net (pensions, healthcare) drives
...
Fisher's debt-deflation framework.
 ...
 • Fisher 1933 debt-deflation: falling prices      • Counter: Chinese government has
   raise real value of nominal debts; indebted       significant policy space (high reserves,
 ...
 • Local-government financing vehicles               growing fast.
   ...
   fiscal-financial loop.                            and the policy response is being calibrated
 • Expectations channel: if deflationary             against it. Likely outcome: prolonged slow
   expectations become entrenched,                   growth with episodic stimulus, rather than a
   households defer consumption and firms            1990s-Japan-style stagnation. Monetary
   defer investment (Japan parallel).                and fiscal authorities will likely act more
...
6(e) · International spillovers of Chinese slowdown (15 marks)
 ...
 • Price channel: Chinese excess capacity →          after 2021–23 inflation episode.
   export of deflationary pressure in              • Industrial policy responses (tariffs,
 ...
 • Financial channel: weakness transmits             fragmentation of the global trading system.
   through commodity prices, FX (yuan),
   investor risk appetite.                         • Judgement: spillovers are real but mixed in
...
Question 7 · Macroeconomic consequences of net-zero transition (25 marks)
 ...
 • Financial stability: stranded-asset risk for    • Transition pace: faster = more inflation
   ...
   duration assets as transition expectations        term.
   change.                                         • Judgement: net-zero transition is likely to
 • Examples: EU carbon-border adjustment             be modestly inflationary in the medium run
   mechanism; US Inflation Reduction Act;            (2030s) but produces positive long-run
   Chinese EV and solar subsidies.                   growth if it raises productivity. Financial-
                                                     stability risks are real and require co-
                                                     ordinated macroprudential response. An
                                                     accelerated transition is likely optimal, but
                                                     requires a credible framework for
...
Question 8 · US dollar, Triffin dilemma, reserve currency (25 marks)
 ...
 • Triffin dilemma: as global reserve-currency     • Counter: USD dominance reflects scale,
   issuer, US must supply liquidity to world         liquidity and rule-of-law advantages that
...
9EC0/02 · Advanced · Mark Scheme                                                          Page 8 of 9
   ...
   of EM central banks.                          risk are comparable or greater. No single
                                                 alternative is credible; a multipolar system
                                                 may emerge slowly, but full dollar
                                                 displacement is decades away.
