...
conjunction with the published question paper.
...
Question 1 (a)
 ...
 two components of Vietnam's aggregate demand.
                                                               2           Annotate with   ✔
                                                                           Accept any two distinct
 Two from:                                                                 components. Do not credit
 • Consumer expenditure / consumption (1)                                  "aggregate demand" itself.
 • Investment (FDI is a form of investment) (1)
 • Exports (1)
 • Imports (1)
 • Net exports (1)
...
Question 1 (b)
 ...
 Using information from the stimulus material,
 calculate to one decimal place Vietnam's terms of
                                                               1           Annotate with   ✔
                                                                           Index of export prices /
 trade in 2023.                                                            Index of import prices ×
 Correct answer = 90.5                                                     100
                                                                           128.5 / 142.0 × 100 =
                                                                           90.4929…
                                                                           = 90.5 (to 1 d.p.)
                                                                           Do not credit 0.9 or 90
...
Question 1 (c)
 ...
 have high FDI and high growth; Cambodia has the lowest                    relationship, not simply
 FDI and relatively low growth (1)                                         restate a value.
 • Exception: Indonesia has the highest FDI (US$22.0bn)
 but only 5.3% growth / Thailand has higher FDI than the
 Philippines but much lower growth (1)
 • The relationship may be weakened by the fact that large
 economies receive more FDI in absolute terms but this
 represents a smaller share of their economy (1)
...
Question 1 (d)
 ...
 Using Table 1, explain the relationship between the
...
in the middle of the range (1)
• A possible explanation is that higher productivity raises
real wages and the returns to work, which encourages
participation; alternatively, countries with high productivity
may use capital-intensive production, which reduces the
demand for labour (1)
...
inflation is likely to harm Vietnam's economic growth. [8]
 ...
 Level 2 (5–8          Good knowledge and understanding of relevant economic idea(s).
 marks)                Good application of economic concepts to the context and some good use of data.
                       Strong analysis characterised by consistently well-developed chains of reasoning.
                       Strong evaluation including consideration of counter arguments / factors that
                       determine extent; a logical and well supported judgement.

 Level 1 (1–4          Reasonable knowledge and understanding of relevant economic idea(s).
 marks)                Reasonable application, possibly inconsistent or not always relevant.
                       Reasonable analysis in the form of single links.
                       Limited evaluation characterised by simple statements / a stated judgement or the
...
● Higher inflation reduces the real purchasing power of household incomes, which can reduce consumer
   expenditure (a component of AD) and slow growth.
● Imported inflation raises firms' costs (cost-push), squeezing profits and reducing investment.
● If the central bank responds with higher interest rates, this would reduce consumption and investment,
    shifting AD leftward.
● Inflation may reduce international competitiveness if it exceeds that of competitor countries, reducing net
    exports.
...
● If inflation is driven by imported commodity prices rather than demand-pull pressure, growth may not slow
    significantly.
● Vietnam's real GDP growth of 8.0% in 2022 is among the highest in the region despite rising inflation,
   suggesting the two can co-exist.
...
● Inflation may harm some groups (low-income consumers, exporters if the exchange rate rises) more than
    others.
...
[12]
 ...
 marks)              Good application, some good use of data.
                     Reasonable analysis characterised by undeveloped chains of reasoning / single
                     links.
                     Reasonable evaluation; consideration of counter arguments; an unsupported
                     judgement.
...
● MNCs typically pay higher wages than domestic firms to attract the best workers, so workers who secure
   these jobs enjoy higher living standards.
● MNCs provide training, transferring skills and technology which permanently raises labour productivity
   (shown by Vietnam's productivity index of 139.2).
● Higher wages and employment raise consumption, creating a multiplier effect that boosts demand for
...
● Environmental damage from some multinational-owned factories imposes costs on workers' health and
   quality of life.
...
Judgement may include
● Whether workers benefit depends on whether the Vietnamese government regulates working conditions,
   environmental standards and ensures wage growth is shared widely.
● The short-run gain (employment, income) is clear; long-run benefits depend on whether productivity and
   skills transfer endure.
● Workers with education and relevant skills will benefit most; unskilled and rural workers may benefit less.
● The overall impact depends on whether FDI complements rather than crowds out domestic firms that may
   pay better long-term.
...
government to achieve its macroeconomic policy objectives. [25]
 ...
 Level 3 (11–15)      Good KU and application, good analysis, reasonable evaluation with an
                      unsupported judgement.
...
● Macroeconomic objectives: stable low inflation, sustainable economic growth, low unemployment, stable
   balance of payments.
...
● Examples include education, training, tax reform, privatisation, deregulation and reducing benefit
   generosity.
