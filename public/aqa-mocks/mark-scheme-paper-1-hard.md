...
support informed judgements.
   ...
   01      Calculate the percentage fall in UK industrial emissions, 2019–2024.       2 marks


Indicative content
Formula: Percentage change = ((New − Old) / Old) × 100
Working: ((79 − 102) / 102) × 100 = (−23 / 102) × 100 = −22.549% ≈ −22.5%
...
direction stated.
           ...
           Diagram and explanation: how a tightening of the cap raises the
   02      carbon permit price.
                                                                                      4 marks


Indicative diagram
A supply-and-demand diagram for tradable pollution permits with:
 • Axes: Price of permits (£ per tonne of CO₂) on the vertical axis, Quantity of permits on
   the horizontal axis.
 • Supply curve is perfectly inelastic (vertical) at the cap Q₁, because the regulator fixes the
   total number of allowances.
 • Downward-sloping demand curve (firms’ willingness to pay for the right to emit CO₂).
 • Initial equilibrium at price P₁, quantity Q₁.
 • Supply shifts left to a new vertical line at Q₂ < Q₁ when the cap is tightened.
 • New equilibrium at P₂ > P₁, quantity Q₂.

Indicative written explanation
The regulator sets the maximum number of allowances equal to the cap, making supply
perfectly inelastic. Firms demand allowances because they need them to cover actual
emissions; this demand is downward-sloping because at higher prices firms find it
worthwhile to abate rather than buy permits. When the regulator tightens the cap, the vertical
supply curve shifts to the left. Holding demand constant, this creates excess demand at the
old price and bids the market price up to P₂. The higher permit price makes emissions-
...
absent but the mechanism is fully explained.
           ...
           Analyse two ways in which the UK ETS may correct the market
   03      failure associated with industrial pollution.
                                                                                       9 marks
...
Way 1: Internalising the externality through a carbon price
Each tonne of CO₂ emitted now carries an explicit price (the permit price). This raises firms’
marginal private cost so that it approaches marginal social cost. On a standard externality
...
Mark scheme — levels
   ...
   Level 3          7–9       Two distinct, fully-developed chains of reasoning linking the
                              ...
                              Accurate diagram support where relevant. Clear and
                              sustained use of the extracts, including data citation.
   Level 2          4–6       Two ways identified but at least one is under-developed, or
                              only one is explored in depth. Some use of the extracts.
                              Minor inaccuracies in economic analysis.
   Level 1          1–3       One mechanism identified; limited development. Diagram
                              missing or inaccurate. Extracts referenced descriptively or
                              not at all.
Maximum 6 marks if only one mechanism is explored in depth, even if excellent. Reward
any economically valid second mechanism, such as revenue generation (hypothecation to
green investment), providing certainty over total emissions, or driving reformulation of supply
chains.
  ...
  04       policy than indirect taxation for reducing industrial carbon emissions.        marks


Arguments supporting tradable permits (FOR)
 • Quantity certainty: the regulator fixes the cap, guaranteeing a maximum level of
   emissions. A carbon tax, by contrast, fixes price but leaves total emissions uncertain. For
   a legally binding Net Zero target, quantity certainty is directly aligned with the policy
   objective.
 • Least-cost abatement: trading equalises marginal abatement costs across firms. Those
   with cheap abatement options cut first and sell surplus permits to firms with high
   abatement costs. This is allocatively efficient and minimises the total cost of hitting the
   cap.
 • Empirical evidence: Extract B shows UK industrial emissions fell by 22.5% between
   2019 and 2024 while the renewable share of generation rose from 37% to 47%. Extract
...
Arguments against permits / in favour of carbon taxation (AGAINST)
 • Price volatility and investment uncertainty: Extract C reports that 41% of energy-
   intensive firms had postponed planned low-carbon investment because of allowance
   price uncertainty. A carbon tax provides a predictable price signal, supporting long-term
   capital planning.
 • Over-allocation risk: Extract A notes environmental groups argue the UK cap is too
...
Relevant extensions and alternatives
 • Hybrid instruments: the UK ETS operates with a minimum auction reserve price,
   providing a floor that functions like a partial tax and reduces downside volatility.
...
has performed well, but the CBI evidence on investment postponement suggests that price
volatility remains a genuine cost. The strongest conclusion is therefore that neither is
universally superior: the best policy for reducing industrial carbon emissions is probably a
...
Mark scheme — levels
   ...
   Level 5        21–25       Sophisticated analysis and evaluation. Sustained chains of
                              ...
                              judgement that addresses the ‘more effective’ comparison
                              directly.
   Level 4        16–20       Good analysis and evaluation. Diagram present and mostly
                              accurate. Two or more developed evaluative points on each
                              side. Supported judgement, possibly less nuanced.
   Level 3        11–15       Sound analysis with some evaluation. Use of extracts is
                              present but may be descriptive. Comparison between permits
                              and taxes may be uneven or judgement asserted.
   Level 2         6–10       Some relevant analysis. Limited evaluation. Weak or partial
                              use of extracts; comparison underdeveloped.
   Level 1         1–5        Limited analysis; evaluation absent or generic. Little or no
           ...
           Explain, using a diagram, how negative externalities of production           15
   05      lead to allocative inefficiency.                                            marks


Required definitions
 • Negative externality of production: a spillover cost imposed on a third party that is not
   reflected in the private costs of the producer. The marginal social cost (MSC) therefore
   lies above the marginal private cost (MPC).
 • Allocative efficiency: occurs when resources are allocated such that marginal social
   benefit (MSB) equals marginal social cost (MSC). At this point no reallocation could
   make society better off.
 • Market failure: the free market fails to allocate resources at the socially optimal level,
   producing a welfare loss.
...
A standard negative-production-externality diagram showing:
 ...
 • Free-market equilibrium at Q₁ where MPC = D, with price P₁.
 • Social optimum at Q* < Q₁ where MSC = D.
 • Welfare loss (deadweight loss) triangle shaded between Q* and Q₁, bounded above by
   MSC and below by MPB.
...
Allocative inefficiency therefore arises because resources are being devoted to the
production of units whose social cost exceeds social benefit. The price mechanism fails to
transmit the full cost of production, leading to overproduction of the polluting good and
underproduction of the unpolluted alternative. Real-world examples include industrial CO₂
emissions, noise and air pollution from road haulage, and effluent discharge from
manufacturing into rivers.
...
Expected content for top-band responses
 • Accurate definitions of MPC, MSC, MEC, MPB/MSB.
 • Fully labelled diagram with welfare loss triangle clearly identified.
 • Clear chain of reasoning from the divergence of MPC and MSC to overproduction at Q₁,
...
Mark scheme — levels
   ...
   Level 4         13–15       Fully developed explanation with accurate, well-labelled
                               ...
                               reasoning from the externality to allocative inefficiency.
                               Appropriate real-world example. Terminology precise
                               throughout.
   Level 3         9–12        Sound explanation with a mostly accurate diagram. Chain of
                               reasoning is clear but may have a minor gap or imprecision.
                               Some real-world application.
   Level 2          5–8        Some understanding. Diagram present but partially
                               inaccurate or incompletely labelled. Allocative inefficiency
                               asserted rather than explained.
   Level 1          1–4        Descriptive only. Diagram missing or significantly flawed.
                               Little use of MSC/MPC framework.
  ...
  06      efficient than command-and-control regulation.”                           marks
...
Arguments in favour of the statement (FOR market-based)
 • Allocative efficiency: market instruments equalise marginal abatement cost across
   firms. Those with the cheapest abatement options act first; high-cost firms pay.
   Command-and-control typically imposes a uniform standard regardless of cost
   differences, leading to unnecessarily high total abatement costs.
 • Dynamic efficiency: a carbon price or tradable permit creates an ongoing incentive to
...
Arguments against the statement (AGAINST market-based / FOR regulation)
 ...
 • Political economy risks: market-based schemes can be watered down via over-
   generous caps (as Extract A suggests some argue for the UK ETS) or successive tax
   cuts. Regulation embedded in law can be more durable.
 ...
 • Coverage gaps: UK ETS covers only large installations; regulation (building energy-
   efficiency standards, Euro 6 emission limits) reaches sectors a carbon price does not
   easily touch.
...
allow any trade, or when the policy goal is a hard sectoral transition such as ending ICE car
sales. In practice the most successful UK environmental policy stack is hybrid: a price-
floored ETS for industry and power, fuel duties for transport, and regulatory mandates for
technology transitions and building standards. The conclusion should therefore reject
...
Mark scheme — levels
   ...
   Level 5         21–25       Sophisticated, balanced analysis and evaluation. Uses
                               ...
                               accurate economic reasoning. Clear, nuanced judgement
                               addressing the word ‘always’ explicitly. Diagrams where
                               helpful.
   Level 4         16–20       Good analysis and evaluation. Uses at least two UK
                               examples. Supported judgement, possibly less developed.
   Level 3         11–15       Sound analysis with some evaluation. One or two UK
                               examples. Judgement may be asserted rather than
                               reasoned.
