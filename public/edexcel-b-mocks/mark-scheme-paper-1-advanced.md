<!-- Auto-generated from /public/edexcel-b-mocks/mark-scheme-paper-1-advanced.pdf -->
Mark Scheme (Results)
...
1 (a)                       Knowledge/Understanding 1, Application 3
            ...
            Operating profit = £223m; Revenue = £2,420m (1)
            (223 ÷ 2,420) × 100 (1)
            = 9.21% (1)


            NB if no working is shown: 9.21% = 4 marks; 9.21 = 3 marks.                         (4)
...
1 (b)                       Knowledge/Understanding 1, Application 3
            ...
            Application: Up to 3 marks for calculations
            Difference = 47,920 − 43,850 = 4,070 (1)
            4,070 ÷ 43,850 (1)
            = 9.28% (1)


            NB if no working is shown: 9.28% = 4 marks; 9.28 = 3 marks.                         (4)
...
1 (c)                 Knowledge/Understanding 2, Application 1, Analysis 1                      (4)
            Knowledge/Understanding: up to 2 marks for
                ...
                •   showing original equilibrium P₁ and Q₁ (1).
...
Number
           ...
           Accept alternative interpretation where demand is argued to shift (e.g. ZEV
           mandate) provided reasoning is coherent and shifts are labelled.
...
1 (d)                Knowledge/Understanding 2, Application 2, Analysis 2
           ...
           Application: up to 2 marks for
               •   Tesla, BMW, Audi and VW combined = 41.1% of UK BEV market (1)
               •   Market structure is concentrated but challenged by new entrants like
                   MG (8.0%) and BYD (3.9%) (1)
 ...
 1 (f)           Knowledge/Understanding 2, Application 2, Analysis 3, Evaluation 3                (10)
              Indicative content
                    ...
                    •   Firms with lower cost bases (Chinese manufacturers, Tesla's vertical
                        integration) can withstand lower prices; others (legacy OEMs with
                        higher unit costs) may struggle.
...
directly connected to the context/issues set out in the stimulus.
 ...
 1 (h)           Knowledge/Understanding 2, Application 2, Analysis 4, Evaluation 4               (12)
              Indicative content
                    •   Contestability requires freedom of entry and exit and low sunk costs.
                        The UK BEV market exhibits mixed features.
...
2             Knowledge/Understanding 4, Application 4, Analysis 6, Evaluation 6
            Indicative content
                 ...
                 •   Overall, the combined policy (removing subsidies + imposing quotas)
                     is likely to accelerate transition without fiscal cost, but creates
                     distributional tensions and near-term margin pressure on
                     manufacturers.                                                          (20)
...
3             Knowledge/Understanding 4, Application 4, Analysis 6, Evaluation 6
            Indicative content
               ...
               •   Overall: increased regulation is likely to produce a net welfare gain
                   provided it addresses genuine market failures without imposing
                   disproportionate compliance costs or deterring investment in charging
                   infrastructure.                                                             (20)
