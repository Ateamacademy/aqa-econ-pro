<!-- Auto-generated from /public/edexcel-b-mocks/mark-scheme-paper-2-advanced.pdf -->
Mark Scheme (Results)
            Predicted Paper
...
Knowledge/understanding: 1 mark for formula: Trade balance in goods and services = Exports − Imports (1).

Application: up to 3 marks: €1.93 trillion (1) − €1.71 trillion (1) = +€0.22 trillion / +€220 billion (1).

NB: If no working is shown: award 4 marks for +€0.22tn or +€220bn; 3 marks for 0.22 or 220 without units;
zero if the sign is wrong.
...
right, compared with a counterfactual higher-investment path.
 ...
 • Germany's gross fixed capital formation is 20.8% of GDP (Extract A); Extract C notes public investment has
   lagged peers for over a decade.
...
Knowledge/understanding 2, Application 2, Analysis 3, Evaluation 3
 • Partnership gives VW faster access to Chinese EV technology (batteries, software, connected-car platforms).
 • Cost-sharing reduces VW's R&D burden during an expensive industry transition.
 • Local partners bring familiarity with Chinese consumer preferences and regulatory environment.
...
Knowledge/understanding 2, Application 2, Analysis 4, Evaluation 4
 ...
 • Fiscal multiplier for infrastructure cited as 1.4–2.1 (Extract C) — each €1bn could add €1.4bn–€2.1bn to GDP in
   the medium term.
                                                                 ...
                                                                 5                                                     Turn over ▶
 • Raises AD in the short run: G rises, creating jobs in construction and engineering (helpful given VW-related job
   losses).
 • Shifts LRAS right in the long run through improved transport, digital and energy infrastructure.
...
Knowledge/understanding 2, Application 2, Analysis 4, Evaluation 4
 • Structural supply-side reforms include labour-market flexibility, energy policy, training, deregulation, and
   innovation support.
...
• Skills training and R&D subsidies help close the EV/software capability gap identified in Extract B.
...
Knowledge/understanding 4, Application 4, Analysis 6, Evaluation 6
 • Growth = increase in real GDP (or per capita); development = broader: health, education, income distribution,
   sustainability, freedoms.
 • Rapid growth can fund development: higher tax revenues enable healthcare, schooling and infrastructure.
 • India's GDP per capita of $9,183 supports rising HDI (0.644), but inequality-adjusted HDI is much lower (0.475),
   suggesting gains are uneven.
 • Indonesia shows similar pattern: GDP per capita $14,687; HDI 0.713; inequality-adjusted HDI 0.584.
 • Ecological footprint matters: India's per capita footprint (1.2 gha) is still below one-Earth sustainability (~1.6 gha),
   but rapid industrialisation is pushing it upward.
 • Ethiopia's gross national savings at 33.1% of GDP provides potential for future investment-led growth.
 • Brazil (GDP per capita $17,827) has relatively high HDI but low savings rate (17.4%), limiting future investment.
...
Knowledge/understanding 4, Application 4, Analysis 6, Evaluation 6
 ...
 • Financial accounting: subsidies flow directly through to retained earnings / investment capacity, strengthening
