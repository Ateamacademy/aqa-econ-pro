<!-- Auto-generated from /public/edexcel-b-mocks/mark-scheme-paper-1-hard.pdf -->
Mark Scheme (Results)
...
1 (a)                         Knowledge/Understanding 1, Application 3
            ...
            Operating profit = £248m; Revenue = £1,450m (1)
            (248 ÷ 1,450) × 100 (1)
            = 17.10% (1)


            NB if no working is shown: 17.10% = 4 marks; 17.10 = 3 marks.                       (4)
...
1 (b)                         Knowledge/Understanding 1, Application 3
            ...
            Application: Up to 3 marks for calculations
            Difference = 11.99 − 8.99 = 3.00 (1)
            3.00 ÷ 8.99 (1)
            = 33.37% (1)


            NB if no working is shown: 33.37% = 4 marks; 33.37 = 3 marks.                       (4)
...
1 (c)                 Knowledge/Understanding 2, Application 1, Analysis 1                      (4)
            Knowledge/Understanding: up to 2 marks for
                •   correctly constructing supply and demand curves and labelling axes
                    with price and quantity (1)
...
Number
           ...
           Accept alternative interpretation where demand is argued to shift (e.g.
           pandemic-era boost) provided reasoning is coherent and shifts are labelled.
...
1 (d)                Knowledge/Understanding 2, Application 2, Analysis 2
           ...
           Application: up to 2 marks for
               •   Netflix, Amazon Prime Video and Disney+ hold 80.5% of UK
                   subscribers combined (1)
               •   The remaining services share only 19.5%, indicating high
                   concentration (1)
...
directly connected to the context/issues set out in the stimulus.
 ...
 1 (h)           Knowledge/Understanding 2, Application 2, Analysis 4, Evaluation 4               (12)
              Indicative content
                    •   Oligopoly features: few large firms (Netflix, Amazon, Disney+ —
                        ...
                        competition.
                    •   Monopolistic competition features: many firms (the extract lists at
                        least nine UK services); product differentiation (genre, curation, UI,
                        content catalogue); relatively free entry of niche operators (MUBI,
                        Shudder); each firm has limited pricing power over its own
 ...
 Number
                    ...
                    •   Regulatory threats (DMA, CMA action) could reduce entrenched
                        platform advantages, making the structure more competitive over
                        time.
...
2             Knowledge/Understanding 4, Application 4, Analysis 6, Evaluation 6
            Indicative content
                 ...
                 •   Impact on inflation: the goal of the tightening cycle; inflation peaked at
                     11.1% and has subsequently fallen, suggesting the policy is working.
                     However, the lag is long (12–24 months).
                 •   Winners: savers, pensioners (higher deposit income); banks (wider
                 ...
                 •   Overall, the rapid rise in interest rates has been effective in cooling
                     ...
                     mortgage holders, housebuilders and discretionary sectors.                    (20)
...
3             Knowledge/Understanding 4, Application 4, Analysis 6, Evaluation 6
            Indicative content
                 ...
                 •   Overall, targeted regulation of specific market failures (gatekeeping,
                     consumer inertia) is likely to produce net welfare gains if implemented
                     carefully; broad content or pricing rules carry greater risk of
                     government failure.                                                         (20)
