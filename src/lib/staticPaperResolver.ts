...
const BOARDS: BoardConfig[] = [
  ...
  // AQA AS Economics · Papers 1 & 2 (7135/1, 7135/2)
  {
    pattern: /^econ-as([12])-([abc])$/i,
    folder: "/aqa-as-mocks",
  ...
  // Edexcel A AS · Papers 1 & 2 (8EC0/01, 8EC0/02)
  {
    pattern: /^edxa-as([12])-([abc])$/i,
    folder: "/edexcel-a-as-mocks",
    displayName: "Edexcel-A-AS-Economics",
    tierMap: { a: "moderate", b: "hard", c: "advanced" },
    allowedPapers: ["1", "2"],
  },
  // Edexcel B A-Level
  ...
  // OCR AS · Papers 1 & 2 (H060/01, H060/02)
  {
    pattern: /^ocr-as([12])-([abc])$/i,
    folder: "/ocr-as-mocks",
    displayName: "OCR-AS-Economics",
    tierMap: { a: "moderate", b: "hard", c: "advanced" },
    allowedPapers: ["1", "2"],
  },
  // CAIE AS · Paper 1 (9708/01), Paper 2 (9708/02) and Paper 3 (9708/03)
  {
    pattern: /^caie-as([1234])-([abc])$/i,
