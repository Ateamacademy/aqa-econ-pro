  ...
  return (
    <div style={{background:'#fff',borderRadius:'8px',padding:'0',maxWidth:'820px',margin:'0 auto',fontFamily:"'Arial',sans-serif",border:'1px solid #ccc',overflow:'hidden'}}>
      <svg viewBox="0 0 820 540" width="100%" style={{display:'block'}}>
        ...
        <text x="300" y="497" fontSize="12" fontWeight="bold" fill="#111">Real Output</text>
        ...
        <text x="338" y="485" textAnchor="middle" fontSize="12" fontWeight="bold" fill="#111">YFE</text>
        ...
        <text x="104" y="216" fontSize="13" fontWeight="bold" fill="#2255cc">AD</text>
        <text x="121" y="216" fontSize="10" fill="#2255cc">1</text>
        ...
        <text x="678" y="497" fontSize="12" fontWeight="bold" fill="#111">Real Output</text>
