  ...
  return (
    <div style={{background:'#fff',borderRadius:'8px',padding:'6px',maxWidth:'680px',margin:'0 auto',fontFamily:"'Arial',sans-serif",border:'1px solid #ccc'}}>
      <svg viewBox="0 0 680 560" width="100%" style={{display:'block'}}>
        ...
        <text x="520.0" y="58.0" fontSize="14" fontWeight="bold" fill="#111">S</text>
        <text x="534.0" y="62.0" fontSize="11" fill="#111">1</text>
        ...
        <text x="250.0" y="362.0" fontSize="10" fill="#cc2222">(supply shock ·</text>
        <text x="250.0" y="375.0" fontSize="10" fill="#cc2222">Brazil frost)</text>
