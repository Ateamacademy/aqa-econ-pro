export default function EconMinWage() {
  return (
    <div style={{background:'#fff',borderRadius:'8px',padding:'6px',maxWidth:'600px',margin:'0 auto',fontFamily:"Arial,sans-serif",border:'1px solid #ccc'}}>
      <svg viewBox="0 0 600 490" width="100%" style={{display:'block'}}>
        <defs>
          <marker id="mw1" markerWidth="9" markerHeight="7" refX="8" refY="3.5" orient="auto"><polygon points="0 0,9 3.5,0 7" fill="#111"/></marker>
          <marker id="mw2" markerWidth="7" markerHeight="9" refX="3.5" refY="1" orient="auto"><polygon points="0 9,3.5 0,7 9" fill="#111"/></marker>
          <marker id="mw3" markerWidth="8" markerHeight="8" refX="4" refY="7" orient="auto"><polygon points="0 0,8 0,4 8" fill="#cc0000"/></marker>
        </defs>
        <rect width="600" height="490" fill="#fff"/>
        <line x1="85" y1="440" x2="85" y2="36" stroke="#111" strokeWidth="2.5" markerEnd="url(#mw2)"/>
        <line x1="85" y1="440" x2="520" y2="440" stroke="#111" strokeWidth="2.5" markerEnd="url(#mw1)"/>
        ...
        <polygon points="192.7,170 301.9,170 256.0,222.9" fill="rgba(200,0,0,0.85)"/>
        ...
        <text x="179.3" y="162.0" fontSize="12.5" fontWeight="bold" fill="#111">Real wage unemployment</text>
        <line x1="256.0" y1="182.0" x2="256.0" y2="210.0" stroke="#cc0000" strokeWidth="2.2" markerEnd="url(#mw3)"/>
      </svg>
    </div>
  );
}