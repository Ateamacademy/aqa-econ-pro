...
const WJEC_MICRO_FAMILIES: DiagramFamilyProfile[] = [
  ...
  },
  {
    ...
    curveNames: ["D", "S", "D₁", "D₂", "S₁", "S₂"],
    requiredLabels: ["P₁", "P₂", "Q₁", "Q₂", "E₁", "E₂", "Axes"],
    commandWords: ["explain", "show", "illustrate", "draw", "analyse"],
    expectedActions: ["draw", "label", "shift", "explain"],
    specKeys: ["wjec_market_equilibrium", "wjec_demand_increase", "wjec_demand_decrease", "wjec_supply_increase", "wjec_supply_decrease", "wjec_interrelated_markets"],
    identificationKeywords: [
      "demand", "supply", "equilibrium", "price determination",
      "excess demand", "excess supply", "shortage", "surplus",
      "price mechanism", "market clearing", "interrelated",
      "substitute", "complement", "shift", "movement along",
    ],
  },
  {
    id: "elasticity",
  ...
  {
    id: "indirect_tax",
    name: "Indirect Tax & Deadweight Loss",
    theme: "Unit 1 / Component 1",
    axes: { x: "Quantity (Q)", y: "Price (P)" },
    ...
    specKeys: ["wjec_indirect_tax", "wjec_dwl_tax"],
    identificationKeywords: [
      "indirect tax", "specific tax", "ad valorem", "tax revenue",
      "tax incidence", "excise duty", "vat", "deadweight loss",
    ],
  },
  {
    id: "subsidy",
  ...
  },
  {
    ...
    identificationKeywords: [
      ...
      "pollution", "overproduction", "underconsumption", "overconsumption",
    ],
  },
  {
    id: "merit_demerit",
    name: "Merit & Demerit Goods (Information Failure)",
    theme: "Unit 1 / Component 1",
    axes: { x: "Quantity (Q)", y: "Price (P)" },
    curveNames: ["D (perceived)", "D (actual)", "S"],
    requiredLabels: ["Perceived vs actual demand", "Welfare loss", "Correction"],
    commandWords: ["explain", "show", "analyse", "evaluate", "discuss"],
    expectedActions: ["draw", "label", "shade", "explain", "evaluate"],
    specKeys: ["wjec_merit_good", "wjec_demerit_good"],
    identificationKeywords: [
      "merit good", "demerit good", "information failure", "asymmetric information",
      "underconsumption", "overconsumption", "perceived", "actual",
      "education", "healthcare", "vaccination", "alcohol", "tobacco", "gambling",
    ],
  },
  {
    id: "labour_market",
  ...
  },
  {
    ...
    expectedActions: ["draw", "label", "shade", "explain", "evaluate"],
    specKeys: ["wjec_monopoly", "wjec_mon_comp", "wjec_perfect_comp", "wjec_kinked_demand"],
    identificationKeywords: [
      ...
      "kinked demand", "price rigidity", "non-price competition",
    ],
  },
];
...
const WJEC_MACRO_FAMILIES: DiagramFamilyProfile[] = [
  {
    ...
    curveNames: ["AD", "AD₁", "AD₂", "SRAS", "SRAS₁", "SRAS₂", "LRAS", "Keynesian AS"],
    requiredLabels: ["Equilibrium", "PL", "Y", "Yn"],
    commandWords: ["explain", "show", "analyse", "evaluate", "discuss"],
    expectedActions: ["draw", "label", "shift", "explain", "evaluate"],
    specKeys: ["wjec_ad_as", "wjec_ad_increase", "wjec_cost_push", "wjec_lras_shift", "wjec_keynesian_as", "wjec_fiscal_expansion", "wjec_monetary_expansion", "wjec_supply_side"],
    identificationKeywords: [
      ...
      "economic growth", "national income", "interest rate",
  ...
  {
    id: "poverty_trap",
    name: "Poverty Trap / Welfare Dependency",
    theme: "Unit 2 / Component 2",
    axes: { x: "Income", y: "Effective Marginal Tax Rate" },
    curveNames: ["EMTR"],
    requiredLabels: ["Trap zone", "Benefits withdrawal", "Normal tax rate"],
    commandWords: ["explain", "analyse", "evaluate"],
    expectedActions: ["draw", "label", "explain", "evaluate"],
    specKeys: ["wjec_poverty_trap"],
    identificationKeywords: [
      "poverty trap", "welfare dependency", "benefits withdrawal",
      "effective marginal tax rate", "universal credit", "means-tested",
    ],
  },
  {
    id: "lorenz_gini",
...
const WJEC_TRADE_FAMILIES: DiagramFamilyProfile[] = [
  ...
  },
  {
    ...
    theme: "Unit 4 / Component 2",
    axes: { x: "Quantity (Q)", y: "Price (P)" },
    curveNames: ["D", "S_dom", "S_dom + subsidy", "Pw"],
    requiredLabels: ["Domestic output change", "Imports change", "Govt cost"],
    commandWords: ["explain", "show", "analyse", "evaluate"],
    expectedActions: ["draw", "label", "shift", "explain", "evaluate"],
    specKeys: ["wjec_trade_subsidy"],
    identificationKeywords: [
      "trade subsidy", "export subsidy", "domestic subsidy",
      "wto", "subsidy protectionism",
    ],
  },
  {
    ...
    curveNames: ["Country A PPF", "Country B PPF"],
    requiredLabels: ["Opportunity cost", "Specialisation", "Terms of trade"],
    commandWords: ["explain", "show", "calculate", "analyse"],
    expectedActions: ["draw", "label", "calculate", "explain"],
    specKeys: ["wjec_comparative_advantage"],
    identificationKeywords: [
      "comparative advantage", "absolute advantage", "specialisation",
      "opportunity cost", "terms of trade", "gains from trade",
    ],
  },
  {
    id: "exchange_rate",
    ...
    curveNames: ["D£", "S£", "D£₁", "D£₂", "S£₁", "S£₂"],
    requiredLabels: ["ER₁", "ER₂", "Appreciation/depreciation arrows"],
    commandWords: ["explain", "show", "analyse", "evaluate"],
    expectedActions: ["draw", "label", "shift", "explain", "evaluate"],
    specKeys: ["wjec_exchange_rate", "wjec_appreciation", "wjec_depreciation"],
    identificationKeywords: [
      "exchange rate", "appreciation", "depreciation",
      "floating", "fixed", "currency", "forex",
      "hot money", "capital flows", "marshall-lerner",
      "j-curve", "competitiveness", "spiced", "wpidec",
    ],
  },
];
