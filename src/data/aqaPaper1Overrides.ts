...
Critics argue that the deeper cause is rapid expansion of student numbers without matching investment in housing capacity.`,
      ...
      q01: "Using the data in Extract A (Table 1), calculate the percentage increase or decrease in the average weekly rent for purpose-built student accommodation between 2018 and 2024. Give your answer to one decimal place and state clearly whether the change is an increase or a decrease.",
      q01Answer: "27.2% increase",
      q01Hint: "((187-147)/147)×100 = +27.2% (increase)",
...
Alternative policies · such as targeted concessionary fares, road pricing, or capital investment in segregated bus lanes · may achieve similar objectives with smaller fiscal cost.`,
      ...
      q05Answer: "9.9% decrease",
      q05Hint: "((172-191)/191)×100 = −9.9% (decrease)",
...
Alternative approaches include encouraging market entry through subsidies for new entrants, public procurement rules, and stronger consumer protection standards.`,
      ...
      q01: `Using the data in Extract A, calculate the percentage increase or decrease in Indicator A between 2019 and 2024. Give your answer to one decimal place and state clearly whether the change is an increase or a decrease.`,
      q01Answer: "35.2% increase",
      q01Hint: "((192-142)/142)×100 = +35.2% (increase)",
      q02: `Explain how the data in Extract A show that ${v.micro1.topic} has changed between 2019 and 2024.`,
      q03: `Extract B (lines 1–3) states that "consumer outcomes have deteriorated". With the help of a diagram and using the extracts, analyse how ${v.micro1.focus} can lead to a welfare loss in ${v.micro1.topic}.`,
      q03Diagram: {
...
Internationally, the OECD has highlighted that countries with stronger competition policy in network industries tend to achieve lower consumer prices and higher long-run investment.`,
      ...
      q07: `Extract E (lines 4–6) states that "high fixed costs and significant economies of scale create natural barriers to entry". With the help of a diagram and using the extracts, analyse how ${v.micro2.focus} can lead to outcomes that differ from those of a perfectly competitive market.`,
      q07Diagram: {
