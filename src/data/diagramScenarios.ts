...
export const diagramScenarios: DiagramScenario[] = [
  ...
  {
    id: "aqa-lorenz-gini",
    section: "Inequality & Development",
    topic: "Lorenz Curve & Gini Coefficient",
    difficulty: "Intermediate",
    scenarioVariant: "Income Distribution — Comparing Two Economies",
    scenario: "The government's statistical agency publishes data comparing income distribution across two economies. Country A is a Scandinavian nation with high taxes and comprehensive welfare, resulting in relatively equal income distribution (Gini ≈ 0.29). Country B is an emerging economy with significant wealth concentration among a small elite, resulting in high inequality (Gini ≈ 0.56).\n\nYou are required to illustrate and compare these two distributions using a Lorenz Curve diagram.",
    question: "Draw and annotate a Lorenz Curve diagram comparing income distribution in Country A and Country B. Using your diagram, explain how the Gini Coefficient is calculated and what it tells us about the degree of income inequality in each country.\n\nYour diagram should include:\n• Both axes labelled (Cumulative % of Population on x-axis; Cumulative % of Income on y-axis)\n• The 45° line of perfect equality\n• Two Lorenz Curves: Country A (closer to equality line) and Country B (further away)\n• Areas A and B labelled, with the Gini Coefficient formula: Gini = A / (A + B)\n• An explanation of why Country B's higher Gini Coefficient indicates greater inequality\n• At least one limitation of using the Gini Coefficient as a measure of inequality [6 marks]",
    marks: 6,
