...
export const OCR_KNOWLEDGE_NODES: KnowledgeNode[] = [
  // Component 01 — Microeconomics
  {
    ...
    topic: "Scarcity & Choice",
    subtopic: "Scarcity, opportunity cost, economic agents",
    paper: "1",
    bloomLevel: "understand",
    keywords: ["scarcity", "opportunity cost", "rational agents", "PPF", "economic problem"],
    relatedTopics: ["ocr-micro-ppf", "ocr-macro-growth"],
    questionStems: ["Explain the concept of scarcity and why it creates the need for choice. [4 marks]"],
    markAllocation: 4,
  },
  {
    id: "ocr-micro-ppf",
    topic: "Production Possibility Frontier",
    subtopic: "PPF, productive efficiency, economic growth",
    paper: "1",
    bloomLevel: "apply",
    keywords: ["PPF", "productive efficiency", "allocative efficiency", "opportunity cost", "growth"],
    relatedTopics: ["ocr-micro-scarcity", "ocr-macro-growth"],
    questionStems: ["Using a PPF diagram, explain how economic growth can be represented. [8 marks]"],
    markAllocation: 8,
  },
  {
    id: "ocr-micro-demand-supply",
    topic: "Price Determination",
    subtopic: "Demand, supply, equilibrium price and quantity",
    paper: "1",
    bloomLevel: "analyse",
    keywords: ["demand", "supply", "equilibrium", "shift", "movement", "price mechanism"],
    relatedTopics: ["ocr-micro-elasticity", "ocr-micro-market-failure"],
    questionStems: ["Using a demand and supply diagram, explain the effect of a minimum price on a market. [8 marks]"],
    markAllocation: 8,
    hotsCategory: "analysis",
  },
  {
    id: "ocr-micro-elasticity",
    topic: "Elasticity",
    subtopic: "PED, PES, YED, XED",
    paper: "1",
    bloomLevel: "apply",
    keywords: ["PED", "PES", "YED", "XED", "elastic", "inelastic", "total revenue"],
    relatedTopics: ["ocr-micro-demand-supply", "ocr-micro-gov-intervention"],
    questionStems: ["Calculate PED from the data and explain its significance for the firm's pricing strategy. [4 marks]"],
    markAllocation: 4,
  },
  {
    id: "ocr-micro-market-failure",
    topic: "Market Failure",
    subtopic: "Externalities, public goods, merit/demerit goods, information gaps",
    paper: "1",
    bloomLevel: "analyse",
    keywords: ["externalities", "public goods", "merit goods", "demerit goods", "asymmetric information", "market failure"],
    relatedTopics: ["ocr-micro-gov-intervention", "ocr-micro-demand-supply"],
    questionStems: ["Using a diagram, explain why a negative externality of production leads to a misallocation of resources. [8 marks]"],
    markAllocation: 8,
    hotsCategory: "analysis",
  },
  {
    id: "ocr-micro-gov-intervention",
    topic: "Government Intervention",
    subtopic: "Taxation, subsidies, regulation, minimum/maximum prices",
    paper: "1",
    bloomLevel: "evaluate",
    keywords: ["indirect tax", "subsidy", "regulation", "maximum price", "minimum price", "government failure"],
    relatedTopics: ["ocr-micro-market-failure", "ocr-micro-elasticity"],
    questionStems: ["Evaluate the effectiveness of indirect taxation as a means of correcting market failure caused by negative externalities. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "ocr-micro-market-structures",
    topic: "Market Structures",
    subtopic: "Perfect competition, monopoly, oligopoly, monopolistic competition, contestability",
    paper: "1",
    bloomLevel: "evaluate",
    keywords: ["monopoly", "oligopoly", "perfect competition", "monopolistic competition", "contestability", "barriers"],
    relatedTopics: ["ocr-micro-gov-intervention", "ocr-macro-supply-side"],
    questionStems: ["Evaluate whether monopolies are always against the consumer interest. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "ocr-micro-labour",
    topic: "Labour Market",
    subtopic: "Wage determination, trade unions, monopsony, minimum wage",
    paper: "1",
    bloomLevel: "analyse",
    keywords: ["MRP", "wages", "trade unions", "monopsony", "minimum wage", "labour supply"],
    relatedTopics: ["ocr-macro-unemployment", "ocr-micro-demand-supply"],
    questionStems: ["Using a labour market diagram, explain how a monopsony employer determines the wage rate. [8 marks]"],
    markAllocation: 8,
    hotsCategory: "analysis",
  },
  ...
  // Component 02 — Macroeconomics
  {
    id: "ocr-macro-ad",
    topic: "Aggregate Demand",
    subtopic: "Components of AD, multiplier",
    paper: "2",
    bloomLevel: "analyse",
    keywords: ["AD", "consumption", "investment", "government spending", "net exports", "multiplier"],
    relatedTopics: ["ocr-macro-fiscal", "ocr-macro-monetary"],
    questionStems: ["Using an AD/AS diagram, explain the likely impact of an increase in government spending. [8 marks]"],
    markAllocation: 8,
    hotsCategory: "analysis",
  },
  {
    ...
    paper: "2",
    bloomLevel: "analyse",
    keywords: ["SRAS", "LRAS", "Keynesian", "Classical", "productive capacity"],
    relatedTopics: ["ocr-macro-growth", "ocr-macro-supply-side"],
    questionStems: ["Compare the Classical and Keynesian views of the aggregate supply curve. [8 marks]"],
    markAllocation: 8,
  },
  {
    id: "ocr-macro-fiscal",
    topic: "Fiscal Policy",
    subtopic: "Government spending, taxation, budget deficit/surplus",
    paper: "2",
    bloomLevel: "evaluate",
    keywords: ["fiscal policy", "budget deficit", "national debt", "crowding out", "automatic stabilisers"],
    relatedTopics: ["ocr-macro-ad", "ocr-macro-monetary"],
    questionStems: ["Evaluate the effectiveness of fiscal policy in reducing unemployment. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "ocr-macro-monetary",
    topic: "Monetary Policy",
    subtopic: "Interest rates, QE, money supply, Bank of England",
    paper: "2",
    bloomLevel: "evaluate",
    keywords: ["interest rates", "QE", "money supply", "transmission mechanism", "MPC"],
    relatedTopics: ["ocr-macro-inflation", "ocr-macro-ad"],
    questionStems: ["Evaluate the effectiveness of monetary policy in controlling inflation. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "ocr-macro-supply-side",
    topic: "Supply-Side Policies",
    subtopic: "Free market and interventionist supply-side policies",
    paper: "2",
    bloomLevel: "evaluate",
    keywords: ["deregulation", "privatisation", "education", "training", "infrastructure", "LRAS"],
    relatedTopics: ["ocr-macro-growth", "ocr-macro-as"],
    questionStems: ["Evaluate the view that supply-side policies are the most effective way to achieve sustained economic growth. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "ocr-macro-growth",
    topic: "Economic Growth",
    subtopic: "Actual vs potential growth, costs and benefits",
    paper: "2",
    bloomLevel: "evaluate",
    keywords: ["GDP", "actual growth", "potential growth", "recession", "output gap", "sustainability"],
    relatedTopics: ["ocr-macro-as", "ocr-macro-supply-side", "ocr-micro-ppf"],
    questionStems: ["Evaluate the extent to which economic growth is compatible with reducing income inequality. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "ocr-macro-inflation",
    topic: "Inflation",
    subtopic: "CPI, demand-pull, cost-push, consequences",
    paper: "2",
    bloomLevel: "analyse",
    keywords: ["CPI", "demand-pull", "cost-push", "deflation", "hyperinflation", "real values"],
    relatedTopics: ["ocr-macro-monetary", "ocr-macro-phillips"],
    questionStems: ["Using data, calculate the rate of inflation and explain one limitation of the CPI. [4 marks]"],
    markAllocation: 4,
  },
  {
    id: "ocr-macro-unemployment",
    topic: "Unemployment",
    subtopic: "Types, causes, consequences, policies",
    paper: "2",
    bloomLevel: "evaluate",
    keywords: ["structural", "cyclical", "frictional", "seasonal", "claimant count", "ILO"],
    relatedTopics: ["ocr-macro-fiscal", "ocr-macro-phillips", "ocr-micro-labour"],
    questionStems: ["Evaluate the most appropriate policies for reducing structural unemployment. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "ocr-macro-bop",
    topic: "Balance of Payments",
    subtopic: "Current account, capital account, exchange rates",
    paper: "2",
    bloomLevel: "evaluate",
    keywords: ["current account", "trade deficit", "J-curve", "Marshall-Lerner", "exchange rates"],
    relatedTopics: ["ocr-macro-globalisation", "ocr-macro-exchange-rate"],
    questionStems: ["Evaluate the view that a current account deficit is always harmful. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "ocr-macro-globalisation",
    topic: "Globalisation",
    subtopic: "Trade, comparative advantage, protectionism",
    paper: "2",
    bloomLevel: "evaluate",
    keywords: ["free trade", "comparative advantage", "protectionism", "tariffs", "WTO", "Brexit"],
    relatedTopics: ["ocr-macro-bop", "ocr-macro-exchange-rate"],
    questionStems: ["Evaluate the likely impact of Brexit on the UK's trade balance and growth. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "ocr-macro-phillips",
    topic: "Phillips Curve",
    subtopic: "Short-run and long-run Phillips Curve",
    paper: "2",
    bloomLevel: "analyse",
    keywords: ["Phillips Curve", "SRPC", "LRPC", "NAIRU", "expectations"],
    relatedTopics: ["ocr-macro-inflation", "ocr-macro-unemployment"],
    questionStems: ["Using a Phillips Curve diagram, explain the short-run trade-off between inflation and unemployment. [8 marks]"],
    markAllocation: 8,
    hotsCategory: "analysis",
  },
  {
    id: "ocr-macro-exchange-rate",
    topic: "Exchange Rates",
    subtopic: "Floating, fixed, managed, depreciation effects",
    paper: "2",
    bloomLevel: "analyse",
    keywords: ["exchange rate", "floating", "depreciation", "appreciation", "competitiveness"],
    relatedTopics: ["ocr-macro-bop", "ocr-macro-globalisation"],
    questionStems: ["Using a diagram, explain how a depreciation might improve the current account in the long run. [8 marks]"],
    markAllocation: 8,
    hotsCategory: "analysis",
  },
];
...
export const CAMBRIDGE_KNOWLEDGE_NODES: KnowledgeNode[] = [
  // Paper 1 — MCQ (AS)
  {
    ...
    subtopic: "Scarcity, opportunity cost, PPF",
    paper: "1",
    bloomLevel: "apply",
    keywords: ["scarcity", "opportunity cost", "PPF", "factors of production", "rational agents"],
    relatedTopics: ["caie-as-demand-supply", "caie-a2-growth"],
    questionStems: ["What is the opportunity cost of a given decision? (MCQ) [1 mark]"],
    markAllocation: 1,
  },
  {
    id: "caie-as-demand-supply",
    topic: "Price Determination",
    subtopic: "Demand, supply, equilibrium, price mechanism",
    paper: "1",
    bloomLevel: "apply",
    keywords: ["demand", "supply", "equilibrium", "shift", "movement along", "price mechanism"],
    relatedTopics: ["caie-as-elasticity", "caie-as-market-failure"],
    questionStems: ["In a competitive market, what determines the equilibrium price? (MCQ) [1 mark]"],
    markAllocation: 1,
  },
  {
    id: "caie-as-elasticity",
    topic: "Elasticity",
    subtopic: "PED, PES, YED, XED and their applications",
    paper: "1",
    bloomLevel: "apply",
    keywords: ["PED", "PES", "YED", "XED", "total revenue", "elastic", "inelastic"],
    relatedTopics: ["caie-as-demand-supply", "caie-as-gov-intervention"],
    questionStems: ["The PED for a product is -0.5. What happens to total revenue if price rises? (MCQ) [1 mark]"],
    markAllocation: 1,
  },
  {
    id: "caie-as-market-failure",
    topic: "Market Failure",
    subtopic: "Externalities, public goods, merit/demerit goods, information failure",
    paper: "1",
    bloomLevel: "understand",
    keywords: ["externalities", "public goods", "merit goods", "demerit goods", "information failure"],
    relatedTopics: ["caie-as-gov-intervention", "caie-as-demand-supply"],
    questionStems: ["Which combination of characteristics describes a public good? (MCQ) [1 mark]"],
    markAllocation: 1,
  },
  {
    id: "caie-as-gov-intervention",
    topic: "Government Intervention",
    subtopic: "Taxes, subsidies, price controls, regulation",
    paper: "1",
    bloomLevel: "apply",
    keywords: ["indirect tax", "subsidy", "maximum price", "minimum price", "regulation", "government failure"],
    relatedTopics: ["caie-as-market-failure", "caie-as-elasticity"],
    questionStems: ["A government imposes a maximum price below equilibrium. What is the most likely result? (MCQ) [1 mark]"],
    markAllocation: 1,
  },
  ...
  // Paper 2 — Data Response & Essay (AS)
  {
    ...
    topic: "Data Response",
    subtopic: "Calculations, diagram analysis, short explanations",
    paper: "2",
    bloomLevel: "apply",
    keywords: ["calculation", "XED", "PED", "data interpretation", "diagram"],
    relatedTopics: ["caie-as-elasticity", "caie-as-demand-supply"],
    questionStems: ["Using the data provided, calculate the cross elasticity of demand and explain what it indicates. [4 marks]"],
    markAllocation: 4,
  },
  {
    id: "caie-as-essay-micro",
    topic: "AS Microeconomics Essay",
    subtopic: "Market failure, government intervention, evaluation",
    paper: "2",
    bloomLevel: "evaluate",
    keywords: ["evaluation", "market failure", "government intervention", "externalities", "demerit goods"],
    relatedTopics: ["caie-as-market-failure", "caie-as-gov-intervention"],
    questionStems: ["Discuss whether indirect taxes are the most effective way to correct market failure caused by demerit goods. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  ...
  // Paper 3 — MCQ (A2)
  {
    id: "caie-a2-ad",
    topic: "Aggregate Demand",
    subtopic: "AD components, shifts, multiplier",
    paper: "3",
    bloomLevel: "apply",
    keywords: ["AD", "consumption", "investment", "government spending", "net exports", "multiplier"],
    relatedTopics: ["caie-a2-fiscal", "caie-a2-monetary"],
    questionStems: ["An economy is operating below full capacity. An increase in AD will most likely cause... (MCQ) [1 mark]"],
    markAllocation: 1,
  },
  {
    id: "caie-a2-as-theory",
    topic: "Aggregate Supply",
    subtopic: "SRAS, LRAS, Classical vs Keynesian",
    paper: "3",
    bloomLevel: "understand",
    keywords: ["SRAS", "LRAS", "Classical", "Keynesian", "vertical", "horizontal"],
    relatedTopics: ["caie-a2-growth", "caie-a2-supply-side"],
    questionStems: ["Which of the following is a supply-side policy? (MCQ) [1 mark]"],
    markAllocation: 1,
  },
  {
    id: "caie-a2-trade",
    topic: "International Trade",
    subtopic: "Comparative advantage, terms of trade, protectionism",
    paper: "3",
    bloomLevel: "apply",
    keywords: ["comparative advantage", "terms of trade", "tariffs", "quotas", "WTO"],
    relatedTopics: ["caie-a2-bop", "caie-a2-development"],
    questionStems: ["According to comparative advantage, which country should specialise? (MCQ) [1 mark]"],
    markAllocation: 1,
  },
  {
    id: "caie-a2-bop",
    topic: "Balance of Payments",
    subtopic: "Current account, capital/financial account",
    paper: "3",
    bloomLevel: "understand",
    keywords: ["current account", "capital account", "financial account", "deficit", "surplus"],
    relatedTopics: ["caie-a2-trade", "caie-a2-exchange-rate"],
    questionStems: ["A country's current account shows a deficit. What might cause this? (MCQ) [1 mark]"],
    markAllocation: 1,
  },
  ...
  // Paper 4 — Data Response & Essay (A2)
  {
    ...
    topic: "Exchange Rates",
    subtopic: "Floating, fixed, managed, depreciation/appreciation effects",
    paper: "4",
    bloomLevel: "analyse",
    keywords: ["exchange rate", "depreciation", "appreciation", "Marshall-Lerner", "J-curve"],
    relatedTopics: ["caie-a2-bop", "caie-a2-trade"],
    questionStems: ["Using an AD/AS diagram, analyse the effects of a significant currency depreciation. [8 marks]"],
    markAllocation: 8,
    hotsCategory: "analysis",
  },
  {
    id: "caie-a2-fiscal",
    topic: "Fiscal Policy",
    subtopic: "Budget deficit, national debt, crowding out",
    paper: "4",
    bloomLevel: "evaluate",
    keywords: ["fiscal policy", "budget deficit", "national debt", "crowding out", "multiplier"],
    relatedTopics: ["caie-a2-ad", "caie-a2-monetary"],
    questionStems: ["Discuss the likely consequences of a large budget deficit for an economy. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "caie-a2-monetary",
    topic: "Monetary Policy",
    subtopic: "Interest rates, inflation targeting, QE",
    paper: "4",
    bloomLevel: "evaluate",
    keywords: ["interest rates", "inflation targeting", "QE", "transmission mechanism"],
    relatedTopics: ["caie-a2-ad", "caie-a2-fiscal"],
    questionStems: ["Assess the effectiveness of monetary policy in achieving price stability and growth. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "caie-a2-supply-side",
    topic: "Supply-Side Policies",
    subtopic: "Market-based and interventionist approaches",
    paper: "4",
    bloomLevel: "evaluate",
    keywords: ["supply-side", "deregulation", "privatisation", "education", "infrastructure"],
    relatedTopics: ["caie-a2-growth", "caie-a2-as-theory"],
    questionStems: ["Evaluate the extent to which supply-side policies can solve unemployment in a developing economy. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "caie-a2-growth",
    topic: "Economic Growth",
    subtopic: "Growth vs development, sustainability, HDI",
    paper: "4",
    bloomLevel: "evaluate",
    keywords: ["GDP", "HDI", "growth", "development", "sustainability", "green growth"],
    relatedTopics: ["caie-a2-supply-side", "caie-a2-development"],
    questionStems: ["Discuss whether economic growth necessarily leads to economic development. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "caie-a2-development",
    topic: "Economic Development",
    subtopic: "Developing economies, trade, aid, FDI",
    paper: "4",
    bloomLevel: "evaluate",
    keywords: ["development", "HDI", "FDI", "aid", "infant industry", "debt", "poverty"],
    relatedTopics: ["caie-a2-trade", "caie-a2-growth"],
    questionStems: ["Evaluate whether protectionist policies can ever be justified for a developing economy. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
  {
    id: "caie-a2-integration",
    topic: "Economic Integration",
    subtopic: "Customs unions, free trade areas, trade creation/diversion",
    paper: "4",
    bloomLevel: "evaluate",
    keywords: ["customs union", "free trade area", "trade creation", "trade diversion", "EU", "ASEAN"],
    relatedTopics: ["caie-a2-trade", "caie-a2-bop"],
    questionStems: ["Evaluate the economic arguments for and against joining a customs union. [12 marks]"],
    markAllocation: 12,
    hotsCategory: "evaluation",
  },
];
