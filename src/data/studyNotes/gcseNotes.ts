    ...
    subtopics: [
      ...
      },
      {
        ...
        keyTerms: [
          ...
          { term: "Floating Exchange Rate", definition: "Rate determined by supply and demand in the market" },
          { term: "Fixed Exchange Rate", definition: "Rate set by the government or central bank" },
        ],
        explanation: "**Strong pound (appreciation):**\n- Imports CHEAPER → good for consumers buying foreign goods\n- Exports MORE EXPENSIVE → bad for UK businesses selling abroad\n- Remember: **SPICED** — Strong Pound Imports Cheap, Exports Dear\n\n**Weak pound (depreciation):**\n- Imports MORE EXPENSIVE → prices rise (inflation)\n- Exports CHEAPER → good for UK businesses\n- Remember: **WPIDEC** — Weak Pound Imports Dear, Exports Cheap\n\n**What determines the exchange rate (floating):**\n- Interest rates (higher rates → hot money inflows → appreciation)\n- Trade flows (more exports → more demand for £ → appreciation)\n- Speculation (expectations of future changes)\n- Inflation (lower inflation → more competitive → appreciation)",
        examTip: "Use SPICED and WPIDEC to remember the effects. Always explain WHO benefits and WHO loses from exchange rate changes.",
      },
      {
        title: "Balance of Payments",
        definition: "The **current account** records trade in goods and services between the UK and other countries.",
        keyTerms: [
          { term: "Current Account Deficit", definition: "Imports exceed exports — more money leaving than entering" },
          { term: "Current Account Surplus", definition: "Exports exceed imports — more money entering" },
        ],
        explanation: "**The UK has a current account deficit** — we import more than we export.\n\n**Causes:** Strong pound makes imports cheap, UK consumers like foreign goods, decline in manufacturing (deindustrialisation)\n\n**Does it matter?** A large persistent deficit may signal structural weakness. But it can be financed by capital inflows (foreign investment in the UK).\n\n**Solutions:** Depreciate the currency, boost export competitiveness, restrict imports (protectionism — but risks retaliation)",
      },
      {
        title: "Globalisation",
        definition: "**Globalisation** means world economies becoming more connected through trade, investment, and migration.",
        keyTerms: [
          { term: "Multinational Corporation", definition: "A company that operates in more than one country (e.g., Apple, Amazon, Toyota)" },
          { term: "Foreign Direct Investment", definition: "When a company invests in building/buying business in another country" },
          { term: "Interdependence", definition: "Countries rely on each other for trade, resources, and investment" },
        ],
        explanation: "**Benefits of globalisation:**\n- Lower prices for consumers (goods made where cheapest)\n- More choice and variety\n- Economic growth in developing countries\n- Transfer of technology and ideas\n- Jobs created by multinational companies\n\n**Costs of globalisation:**\n- Job losses in developed countries (factories move abroad)\n- Environmental damage (more transport, less regulation abroad)\n- Exploitation of workers in developing countries (low wages, poor conditions)\n- Loss of local culture and traditions\n- Tax avoidance by large multinationals\n\n**COVID-19 showed risks:** When global supply chains broke down, countries couldn't get essential goods. Some argue for less reliance on global trade.",
        examTip: "For 9-mark questions, always discuss BOTH sides of globalisation and come to a balanced judgement.",
      },
    ],
  },
];
