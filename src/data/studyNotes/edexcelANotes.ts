    ...
    subtopics: [
      {
        ...
        explanation: "**Causes:** Lower transport costs, trade liberalisation (WTO), technology, financial deregulation, TNCs\n\n**Benefits:** Consumer choice, lower prices, technology transfer, economic growth, poverty reduction in developing countries\n**Costs:** Deindustrialisation in developed countries, environmental damage, cultural erosion, growing inequality, exploitation, tax avoidance",
        example: "China's integration has lifted 800 million from poverty but contributed to deindustrialisation in Western economies.",
      },
      {
      ...
      },
      {
        ...
        keyTerms: [
          ...
          { term: "Non-Tariff Barrier", definition: "Regulations, standards that restrict trade" },
        ],
        explanation: "**Arguments for:** Infant industries, national security, preventing dumping, protecting jobs, correcting BoP deficit\n**Arguments against:** Higher prices, inefficiency, retaliation, reduced choice, may protect sunset industries",
      ...
      },
      {
        ...
        explanation: "**Causes of depreciation:** Lower interest rates, higher inflation, poor economic performance, speculation\n**Impact of depreciation:** Exports cheaper → more competitive. Imports dearer → cost-push inflation.\n\n**Marshall-Lerner:** Depreciation improves BoP only if PED(X) + PED(M) > 1\n**J-Curve:** Short-run worsening, long-run improvement",
      ...
      },
      {
        ...
        definition: "**Trading blocs** reduce trade barriers between member states.",
        keyTerms: [
          { term: "Free Trade Area", definition: "No internal tariffs, each sets own external tariffs" },
          { term: "Customs Union", definition: "No internal tariffs + common external tariff" },
          { term: "Single Market", definition: "Free movement of goods, services, capital, labour" },
          { term: "Trade Creation", definition: "Buying from efficient partner instead of domestic producer" },
          { term: "Trade Diversion", definition: "Buying from less efficient partner instead of cheaper non-member" },
        ],
        explanation: "**Benefits:** Larger market, economies of scale, FDI attraction, political stability\n**Costs:** Loss of sovereignty, trade diversion, adjustment costs, uneven benefits\n\n**Brexit:** UK left EU single market/customs union — new trade barriers but regained sovereignty",
      },
    ],
  },
];
