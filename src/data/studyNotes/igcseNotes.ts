    ...
    subtopics: [
      ...
      },
      {
        ...
        keyTerms: [
          ...
          { term: "Developed Country", definition: "High GDP per capita, good health/education, advanced infrastructure" },
      ...
      {
        title: "Globalisation",
        definition: "**Globalisation** is the increasing integration and interdependence of the world's economies.",
        keyTerms: [
          { term: "Globalisation", definition: "Growing links between countries through trade, investment, migration, technology" },
          { term: "Multinational Corporation (MNC)", definition: "A firm that operates in two or more countries" },
          { term: "Free Trade Agreement", definition: "An agreement between countries to reduce trade barriers" },
        ],
        explanation: "**Causes of globalisation:** Lower transport costs, internet and telecommunications, trade liberalisation (WTO), multinational companies, financial deregulation, containerisation\n\n**Benefits for developing countries:**\n- Jobs created by MNCs → higher incomes\n- Technology and skills transfer\n- Access to larger export markets\n- FDI brings investment and infrastructure\n- Tax revenue from MNC operations\n\n**Costs for developing countries:**\n- Exploitation of workers (low wages, poor conditions)\n- Environmental damage (less regulation)\n- Cultural erosion (Western brands replace local culture)\n- Dependency on MNCs (if they leave, jobs disappear)\n- Profits repatriated to home country\n- 'Race to the bottom' on regulations\n\n**Benefits for developed countries:** Lower prices, more choice, new markets, access to cheap labour\n**Costs for developed countries:** Job losses (offshoring), deindustrialisation, growing inequality, environmental concerns",
        example: "Bangladesh's garment industry employs 4 million workers and accounts for 80% of exports. Globalisation brought jobs and growth, but working conditions remain poor (Rana Plaza collapse, 2013).",
      },
    ],
  },
];
