...
export default function EdexcelBPastPapers() {
  ...
  const years = [...new Set(edexcelBPastPapers.map((p) => p.year))]
    ...
    edexcelBPastPapers.filter((p) => {
      ...
      if (search) {
        ...
        return (
          ...
          edexcelBPaperTitles[p.paper].toLowerCase().includes(q)
        );
      }
      return true;
    });
    ...
    <div className="container py-10">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Browse Edexcel Economics B (9EB0) past papers and mark schemes from Physics & Maths Tutor.
        </p>
      </div>
