...
export default function EdexcelAPastPapers() {
  ...
  const years = [...new Set(edexcelAPastPapers.map((p) => p.year))]
    ...
    edexcelAPastPapers.filter((p) => {
      ...
      if (search) {
        ...
        return (
          ...
          edexcelAPaperTitles[p.paper].toLowerCase().includes(q)
        );
      }
      return true;
    });
    ...
    <div className="container py-10">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Browse Edexcel Economics A (9EC0) past papers and mark schemes from Physics & Maths Tutor.
        </p>
      </div>
