...
const AQA_SPECS: TopicSpec[] = [
  {
    ...
    testInputs: [
      ...
      { id: "sd-d-4", input: "Demand shifts right", shiftHint: "Demand shifts right", expectedFigure: "demand_increase" },
      { id: "sd-d-5", input: "Demand shifts left", shiftHint: "Demand shifts left", expectedFigure: "demand_decrease" },
  ...
  },
  {
    ...
    testInputs: [
      ...
      { id: "sd-s-4", input: "Supply shifts right", shiftHint: "Supply shifts right", expectedFigure: "supply_increase" },
      { id: "sd-s-5", input: "Supply shifts left", shiftHint: "Supply shifts left", expectedFigure: "supply_decrease" },
  ...
  },
  {
    ...
    testInputs: [
      ...
      { id: "neg-2", input: "negative externality", expectedFigure: "negative_production_externality" },
