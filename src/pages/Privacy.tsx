  ...
  return (
    <div className="container max-w-3xl py-16">
      ...
      <div className="space-y-4 text-muted-foreground leading-relaxed text-sm">
        ...
        <p>Your data is retained for the duration of your account. You may request deletion at any time by contacting us.</p>
        <h2 className="text-xl font-bold text-foreground pt-2">5. Your Rights</h2>
        <p>You have the right to access, correct, or delete your personal data. Contact us at privacy@econrev.com for any requests.</p>
      </div>
    </div>
  );
}
