...
const AQA_ALEVEL_SPECS: TopicTestSpec[] = [
  {
    ...
    testInputs: [
      ...
      { input: "Demand shifts right", shiftHint: "Demand shifts right", expectedFigure: "demand_increase" },
      { input: "Demand shifts left", shiftHint: "Demand shifts left", expectedFigure: "demand_decrease" },
  ...
  },
  {
    ...
    testInputs: [
      ...
      { input: "Supply shifts right", shiftHint: "Supply shifts right", expectedFigure: "supply_increase" },
      { input: "Supply shifts left", shiftHint: "Supply shifts left", expectedFigure: "supply_decrease" },
