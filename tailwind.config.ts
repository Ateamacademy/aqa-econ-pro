    ...
    extend: {
      ...
      keyframes: {
        ...
        "neon-flicker": {
          ...
          "8%": { opacity: "0.4", filter: "brightness(0.6)" },
          "10%": { opacity: "1", filter: "brightness(1.6)" },
          "20%": { opacity: "0.85", filter: "brightness(0.9)" },
          "50%": { opacity: "1", filter: "brightness(1.8)" },
          "52%": { opacity: "0.5", filter: "brightness(0.7)" },
          "54%": { opacity: "1", filter: "brightness(1.4)" },
          "75%": { opacity: "0.95", filter: "brightness(1.2)" },
        },
      },
      animation: {
        ...
        "neon-flicker": "neon-flicker 2.6s ease-in-out infinite",
      },
    },
  },
